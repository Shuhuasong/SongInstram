package com.example.songinstram
...
class MainActivity : AppCompatActivity() {
    ...
    val CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 1067
    ...
    private fun submitPost(description: String, user: ParseUser, file : File) {
        ...
        post.saveInBackground{ exception ->
            if(exception != null){
                ...
                Toast.makeText(this, "Error when saving post", Toast.LENGTH_SHORT).show()
            }else{
                Log.i(TAG, "Successfully saved post")
                //TODO: Resettng the edittext field to be empty
